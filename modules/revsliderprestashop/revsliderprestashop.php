                    ...
                    if (@RevsliderPrestashop::getIsset($params->template) && $params->template != 'false') {
                        ...
                        if (@RevsliderPrestashop::getIsset($params->id_shop) && $params->id_shop != Shop::getContextShopID()) {
                            ...
                            if(isset($params->filmstrip_enabled)){
                                ...
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-filmstrip-addon/public/assets/css/revolution.addon.filmstrip.css');
                                $this->context->controller->registerJavascript('addon-filmstrip', 'modules/'.$this->name.'/addons/revslider-filmstrip-addon/public/assets/js/revolution.addon.filmstrip.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->particles_enabled)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-particles-addon/public/assets/css/revolution.addon.particles.css');
                                $this->context->controller->registerJavascript('addon-particles', 'modules/'.$this->name.'/addons/revslider-particles-addon/public/assets/js/revolution.addon.particles.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->polyfold_bottom_enabled) || isset($params->polyfold_top_enabled)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-polyfold-addon/public/assets/css/revolution.addon.polyfold.css');
                                $this->context->controller->registerJavascript('addon-polyfold', 'modules/'.$this->name.'/addons/revslider-polyfold-addon/public/assets/js/revolution.addon.polyfold.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->typewriter_defaults_enabled)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-typewriter-addon/public/assets/css/revolution.addon.typewriter.css');
                                $this->context->controller->registerJavascript('addon-typewriter', 'modules/'.$this->name.'/addons/revslider-typewriter-addon/public/assets/js/revolution.addon.typewriter.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->slicey_enabled)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-slicey-addon/public/assets/css/revolution.addon.slicey.css');
                                $this->context->controller->registerJavascript('addon-slicey', 'modules/'.$this->name.'/addons/revslider-slicey-addon/public/assets/js/revolution.addon.slicey.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->snow_enabled)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-snow-addon/public/assets/css/revolution.addon.snow.css');
                                $this->context->controller->registerJavascript('addon-snow', 'modules/'.$this->name.'/addons/revslider-snow-addon/public/assets/js/revolution.addon.snow.min.js', ['position' => 'bottom', 'priority' => 1500]);  
            
                            }
                            if(isset($params->wb_enable)){
                
                                $this->context->controller->addCSS(RS_PLUGIN_ADDONS_URL . 'revslider-whiteboard-addon/public/assets/css/revolution.addon.whiteboard.css');
                                $this->context->controller->registerJavascript('addon-whiteboard', 'modules/'.$this->name.'/addons/revslider-whiteboard-addon/public/assets/js/revolution.addon.whiteboard.min.js', ['position' => 'bottom', 'priority' => 1500]);  
