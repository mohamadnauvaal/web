...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayFooter', 'displayLeftColumn', 'displayRightColumn',  'displayWrapperTopInContainer', 'displayWrapperTop', 'displayNavCenter', 'displayWrapperBottom', 'displayWrapperBottomInContainer', 'displayMyAccountDashboard', 'displayReassurance', 'displayRightColumnProduct', 'displayNav1', 'displayNav2', 'displayProductAdditionalInfo'];
    ...
    {
        $usableHooks = ['displayFooter', 'displayLeftColumn', 'displayRightColumn',   'displayWrapperTopInContainer', 'displayWrapperTop', 'displayWrapperBottom', 'displayWrapperBottomInContainer',  'displayMyAccountDashboard',  'displayReassurance', 'displayRightColumnProduct', 'displayBanner', 'displayProductAdditionalInfo'];
