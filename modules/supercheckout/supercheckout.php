...
//        }
    ...
    public function hookDisplayHeader()
    {
        ...
        // dodol
        $kurirq_ajax_url = $this->context->link->getModuleLink('kurirq', 'ajax', array(), true);
        Media::addJsDefL('District', $this->l('District'));
        Media::addJsDefL('SubDistrict', $this->l('Sub District'));
        Media::addJsDef(array('kurirq_ajax_url' => $kurirq_ajax_url, 'kurirq_token' => Tools::getToken(false)));        
    }
