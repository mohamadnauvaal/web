...
//            $this->module_dir . 'views/js/front/jquery.colorbox.js',
    ...
    protected function initCheckoutAddresses($id_country = 0, $id_state = 0, $postcode = '', $id_address_delivery = 0, $id_district = 0, $id_subdistrict = 0)
    {
        if (empty($id_country)) {
...
//                    $delivery_address->vat_number = ' ';
                    ...
                    $delivery_address->id_district = (int)$id_district; // KURIRQ
                    $delivery_address->id_subdistrict = (int)$id_subdistrict; // KURIRQ
...
//        }
    ...
    protected function getGuestInformations()
    {
        ...
        return array(
            ...
            'id_district' => (int) $address_delivery->id_district, // KURIRQ
            'id_subdistrict' => (int) $address_delivery->id_subdistrict,
