...
$(document).ready(function() {
    ...
    $('select[name="id_subdistrict"]').change(function() {
        loadCarriers();
        $('input[name="shipping_address[city]"]').val($('select[name=\'id_subdistrict\'] option:selected').text()+', '+$('select[name=\'id_district\'] option:selected').text()+', '+$('select[name="shipping_address[id_state]"] option:selected').text());
    });
    ...
    $('#shipping-new').on('change', 'select[name="shipping_address[id_state]"]', function() {
        ...
        if ($('select[name="shipping_address[id_country]"]').val() == 111) {
            console.log('load district');
            loadDistrict($('select[name="shipping_address[id_state]"]').val());
        }
...
function loadCarriers() {
    ...
    var id_state = 0;
    var id_district = $('select[name="id_district"] option:selected').val(); // kurirq
    var id_subdistrict = $('select[name="id_subdistrict"] option:selected').val(); // kurirq
    ...
    $.ajax({
        ...
        cache: false,
        dataType: "json", // dodol
        data: 'ajax=true' + '&id_country=' + id_country + '&id_state=' + id_state + '&postcode=' + postcode +'&id_district=' + id_district +'&id_subdistrict=' + id_subdistrict + '&vat_number=' + vat_code + '&id_address_delivery=' + id_address_delivery + '&method=loadCarriers&token=' + prestashop.static_token,
        beforeSend: function() {
            $('.velsof_sc_overlay').show();
...
function attachDistrict()
{
    console.log('attach district');
    var district = '<tr class="sort_data"><td>District:<select class="supercheckout-large-field" name="id_district" id="id_district"></select></td></tr>';
    var subDistrict = '<tr class="sort_data"><td>Sub District:<select class="supercheckout-large-field" name="id_subdistrict" id="id_subdistrict"></select></td></tr>';
    if (!$('select[name="id_district"]').length) {
        $('select[name="shipping_address[id_state]"]').parent().parent().after(district);
