...
function upgrade_module_1_1_4($object)
{
    ...
    Db::getInstance()->Execute('CREATE TABLE IF NOT EXISTS `PREFIXiqit_elementor_category` (
  ...
  PRIMARY KEY (`id_elementor`, `id_category`)
    ...
    Db::getInstance()->Execute('CREATE TABLE IF NOT EXISTS `PREFIXiqit_elementor_category_lang` (
