        ...
        if ( $video_html ) : ?>
            <?php if (  $instance['in_modal'] === 'yes' ) : ?>
                ...
                <button class="elementor-video-open-modal" data-toggle="modal"
                     data-target="#elementor-video-modal-<?php echo $instance['id_widget_instance'] ?>">
                    <i class="fa fa-play-circle"></i>
                </button>


                <div class="modal fade elementor-video-modal" id="elementor-video-modal-<?php echo $instance['id_widget_instance'] ?>">
