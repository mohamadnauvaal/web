...
class __TwigTemplate_58c1a3d4a0f7fbd7c94a48f6015c8ccfcfffdab7b69c779466cd167a8bf8691c extends \Twig\Template
{
...
";
    ...
    public function block_product_catalog_form_table_row($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : null), "id_product", []), "html", null, true);
        echo "\">
        ...
        echo "#tab-step1\">";
        echo $this->getAttribute((isset($context["product"]) ? $context["product"] : null), "image", []);
        echo "</a>
        </td>
        <td>
            <a href=\"";
        ...
        if ($this->env->getExtension('PrestaShopBundle\Twig\LayoutExtension')->getConfiguration("PS_STOCK_MANAGEMENT")) {
            ...
            echo "#tab-step3\">
                    ";
            // line 67
            if (($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "sav_quantity", [], "any", true, true) && ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "sav_quantity", []) > 0))) {
                // line 68
                echo "                        ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : null), "sav_quantity", []), "html", null, true);
                echo "
                    ";
            } else {
                // line 70
        ...
        if ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "position", [], "any", true, true)) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : null), "position", []), "html", null, true);
            echo "</span>
...
(isset($context["product"]) ? $context["product"] : null), "preview_url", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "preview_url", []), "#")) : ("#")), "target" => "_blank", "icon" => "remove_red_eye", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Preview", [], "Admin.Actions")]];
        ...
        echo "
                ";
        // line 110
        $context["buttons_action"] = twig_array_merge((isset($context["buttons_action"]) ? $context["buttons_action"] : null), [0 => ["onclick" => "unitProductAction(this, 'duplicate');", "icon" => "content_copy", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Duplicate", [], "Admin.Actions")]]);
        // line 117
        echo "
                ";
        // line 118
        $context["buttons_action"] = twig_array_merge((isset($context["buttons_action"]) ? $context["buttons_action"] : null), [0 => ["onclick" => "unitProductAction(this, 'delete');", "icon" => "delete", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Delete", [], "Admin.Actions")]]);
        // line 125
        echo "
                ";
        // line 126
...
(isset($context["product"]) ? $context["product"] : null), "id_product", [])) . "_menu"), "default_item" => ["href" => (($this->getAttribute(        // line 129
...
(isset($context["buttons_action"]) ? $context["buttons_action"] : null)]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Product/CatalogPage/Lists/list.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/CatalogPage/Lists/list.html.twig");
    }
}
