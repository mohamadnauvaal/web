...
class __TwigTemplate_5c31cce30507295b6ab5e52378899617d149aa0f299f03a2f54023d7d0c03cb5 extends \Twig\Template
{
...
<a class=\"";
   ...
   data-customer-id=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["record"]) ? $context["record"] : null), $this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "customer_id_field", []), [], "array"), "html", null, true);
        echo "\"
   data-customer-delete-url=\"";
        // line 35
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath($this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "customer_delete_route", []));
        echo "\"
  ";
        // line 36
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Actions/Row/delete_customer.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Actions/Row/delete_customer.html.twig");
    }
}
