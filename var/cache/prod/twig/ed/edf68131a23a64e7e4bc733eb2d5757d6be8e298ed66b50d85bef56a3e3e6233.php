...
class __TwigTemplate_d5c35feb7adb46a96f8a6e35ab22ec64fda9354b86d9e1524300f96e96faa0a7 extends \Twig\Template
{
...
<div class=\"categories-tree js-categories-tree\">
  <fieldset class=\"form-group\">
    <div class=\"ui-widget\">
      ...
      ";
        // line 36
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Category/categories.html.twig", ["categories" => (isset($context["categories"]) ? $context["categories"] : null)]);
        echo "
      ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "id_category_default", []), 'errors');
        echo "
      ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "id_category_default", []), 'widget');
        echo "
      ...
      ";
        // line 43
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "categories", []), 'widget', ["defaultCategory" => true]);
        echo " ";
        // line 44
        echo "    </div>
  </fieldset>
  ";
        // line 46
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "categories", []), 'errors');
        echo "
  ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "categories", []), 'widget');
        echo " ";
        // line 48
        echo "</div>
<div id=\"add-categories\">
  ...
  <div id=\"add-categories-content\" class=\"hide\">
    <div id=\"form_step1_new_category\" data-action=\"";
        // line 56
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_category_simple_add_form", ["id_product" => (isset($context["productId"]) ? $context["productId"] : null)]), "html", null, true);
        echo "\">
      <fieldset class=\"form-group\">
        ...
        ";
        // line 59
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "new_category", []), 'errors');
        echo "
        ";
        // line 60
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "new_category", []), "name", []), 'widget');
        echo "
      </fieldset>
      ...
      <fieldset class=\"form-group\">
        <label class=\"form-control-label\">";
        // line 66
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "new_category", []), "id_parent", []), "vars", []), "label", []), "html", null, true);
        echo "</label>
        ";
        // line 67
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "new_category", []), "id_parent", []), 'widget');
        echo "
      </fieldset>
...
";
    ...
    {
        return new Source("", "@Product/ProductPage/Forms/form_categories.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_categories.html.twig");
    }
}
