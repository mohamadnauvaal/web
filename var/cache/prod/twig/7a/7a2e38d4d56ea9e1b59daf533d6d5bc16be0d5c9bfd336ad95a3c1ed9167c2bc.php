...
class __TwigTemplate_bbf72664a7af326deefc28d7fcca75bc44f7c351860f5f7cbfb4e0bd35643258 extends \Twig\Template
{
    ...
    public function block_maintenance_form_general($context, array $blocks = [])
    {
        ...
        echo "
                <div class=\"col-sm\">
                  ";
        // line 45
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "enable_shop", []), 'errors');
        echo "
                  ";
        // line 46
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "enable_shop", []), 'widget');
        echo "
                </div>
              </div>
              <div class=\"form-group row\">
        ...
        echo "
                <div class=\"col-sm\">
                  ";
        // line 52
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_ip", []), 'errors');
        echo "
                  ";
        // line 53
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_ip", []), 'widget', ["currentIp" => (isset($context["currentIp"]) ? $context["currentIp"] : null)]);
        echo "
                </div>
              </div>
              <div class=\"form-group row\">
        ...
        echo "
                <div class=\"col-sm\">
                  ";
        // line 59
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_text", []), 'errors');
        echo "
                  ";
        // line 60
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_text", []), 'widget');
        echo "
                </div>
              </div>
              ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Configure/ShopParameters/maintenance.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/maintenance.html.twig");
    }
}
