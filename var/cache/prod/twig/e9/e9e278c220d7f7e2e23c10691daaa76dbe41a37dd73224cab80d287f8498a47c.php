...
class __TwigTemplate_61cc3d2bcc56b35d55630a7e0864a271ece6da7fce1be6cb38dfe08b103108e7 extends \Twig\Template
{
    ...
    {
        // line 25
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["form"]) ? $context["form"] : null), "suppliers", [])) > 0)) {
            // line 26
            echo "  <div id=\"form_step6_suppliers_custom_fields\">
    <h2>";
            // line 27
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "suppliers", []), "vars", []), "label", []), "html", null, true);
            echo "</h2>
    <div class=\"row mb-1\">
      <div class=\"col-md-12\">
    ...
    <div class=\"panel panel-default\">
      <div class=\"panel-body\">
        <div>
          ";
            // line 50
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "suppliers", []), 'errors');
            echo "
          <table class=\"table\" id=\"form_step6_suppliers\">
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "suppliers", []));
            foreach ($context['_seq'] as $context["key"] => $context["supplier"]) {
                ...
                <td>";
                // line 62
                echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "default_supplier", []), $context["key"], [], "array"), 'widget');
                echo "</td>
              </tr>
            ";
            }
...
";
    ...
    {
        return new Source("", "@Product/ProductPage/Forms/form_supplier_choice.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_supplier_choice.html.twig");
    }
}
