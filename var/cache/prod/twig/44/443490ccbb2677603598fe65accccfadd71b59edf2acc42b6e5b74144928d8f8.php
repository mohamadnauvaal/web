...
class __TwigTemplate_d59bd5f5d2b282b298fc9dc633c03a39db03b888ff585210a8b610eeec9029fa extends \Twig\Template
{
    ...
    {
        // line 25
        $context["buttonType"] = (((isset($context["buttonType"]) || array_key_exists("buttonType", $context))) ? (_twig_default_filter((isset($context["buttonType"]) ? $context["buttonType"] : null), "primary")) : ("primary"));
        // line 26
        $context["right"] = (((isset($context["right"]) || array_key_exists("right", $context))) ? (_twig_default_filter((isset($context["right"]) ? $context["right"] : null), false)) : (false));
        // line 27
        echo "
<div class=\"";
        // line 28
        echo twig_escape_filter($this->env, (((isset($context["div_style"]) || array_key_exists("div_style", $context))) ? (_twig_default_filter((isset($context["div_style"]) ? $context["div_style"] : null), "btn-group dropdown")) : ("btn-group dropdown")), "html", null, true);
        echo "\">
  ...
  ";
      ...
      ";
            // line 35
            if (((isset($context["disabled"]) || array_key_exists("disabled", $context)) && ((isset($context["disabled"]) ? $context["disabled"] : null) == true))) {
      ...
      ";
            // line 37
            if ($this->getAttribute((isset($context["default_item"]) ? $context["default_item"] : null), "icon", [])) {
                // line 38
                echo "        <i class=\"material-icons\">";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["default_item"]) ? $context["default_item"] : null), "icon", []), "html", null, true);
                echo "</i>
      ";
            }
            // line 40
  ...
  >
    ";
        // line 50
        echo twig_escape_filter($this->env, (((isset($context["menu_label"]) || array_key_exists("menu_label", $context))) ? (_twig_default_filter((isset($context["menu_label"]) ? $context["menu_label"] : null), "")) : ("")), "html", null, true);
        echo "
    <i class=\"";
        // line 51
        echo twig_escape_filter($this->env, (((isset($context["menu_icon"]) || array_key_exists("menu_icon", $context))) ? (_twig_default_filter((isset($context["menu_icon"]) ? $context["menu_icon"] : null), "icon-caret-down")) : ("icon-caret-down")), "html", null, true);
        echo "\"></i>
  </button>
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/dropdown_menu.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Helpers/dropdown_menu.html.twig");
    }
}
