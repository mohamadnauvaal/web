...
class __TwigTemplate_13efcc43fb967909e317a0bad3c1b3ba82902cf738c95a60893f4f2f69bb8c04 extends \Twig\Template
{
    ...
    <div class=\"modal-dialog ";
        ...
        if ((isset($context["progressbar"]) || array_key_exists("progressbar", $context))) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["progressbar"]) ? $context["progressbar"] : null), "id", []), "html", null, true);
            echo "\">
...
<script>
    \$(document).ready(function() {
        var closable = ";
        // line 76
        if (((isset($context["closable"]) || array_key_exists("closable", $context)) && ((isset($context["closable"]) ? $context["closable"] : null) == true))) {
            echo "true";
        } else {
            echo "false";
        }
...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
