...
class __TwigTemplate_bfe8baa4212d246f27c94fb913c6eff915b09f5721e9700edfd476cc45f4a285 extends \Twig\Template
{
...
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "url", []), $this->getAttribute($this->getAttribute($this->getAttribute(        // line 27
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "price", []), "raw", []), $this->getAttribute($this->getAttribute($this->getAttribute(        // line 28
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "price", []), "displayPrice", []), $this->getAttribute($this->getAttribute(        // line 29
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "url_active", []), $this->getAttribute($this->getAttribute(        // line 30
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "urls", []), $this->getAttribute($this->getAttribute(        // line 31
(isset($context["module"]) ? $context["module"] : null), "attributes", []), "name", [])];
        // line 33
...
(isset($context["name"]) ? $context["name"] : null), "classes_form" => "btn-group form-action-button", "classes" => "btn btn-primary-reverse btn-outline-primary", "url" => $this->getAttribute(            // line 43
(isset($context["urls"]) ? $context["urls"] : null), (isset($context["url_active"]) ? $context["url_active"] : null), [], "array"), "action" =>             // line 44
(isset($context["url_active"]) ? $context["url_active"] : null)]));
            // line 46
            echo "    ";
...
(isset($context["name"]) ? $context["name"] : null), "classes" => "dropdown-item", "url" =>                         // line 59
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/action_menu.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/action_menu.html.twig");
    }
}
