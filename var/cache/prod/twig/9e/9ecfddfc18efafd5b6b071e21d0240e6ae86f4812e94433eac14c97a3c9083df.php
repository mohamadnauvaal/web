...
class __TwigTemplate_d2ecfe648137fddcabad4e7589e0c4da4ed1894e4ce365638f10893ae0da2cbb extends \Twig\Template
{
    ...
    <div class=\"col-lg-10\">
      ";
        ...
        // line 35
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_addons_connect.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 35)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : null), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : null)]));
        // line 36
        echo "      ";
        // line 37
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_import.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 37)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : null), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : null)]));
        // line 38
        echo "      ";
        // line 39
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 39)->display(twig_array_merge($context, ["topMenuData" => (isset($context["topMenuData"]) ? $context["topMenuData"] : null), "bulkActions" => (isset($context["bulkActions"]) ? $context["bulkActions"] : null)]));
        // line 40
        echo "
      ";
        // line 41
...
";
    ...
    public function block_catalog_categories_listing($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["categories"]) ? $context["categories"] : null), "subMenu", []));
        $context['loop'] = [
    ...
    public function block_addon_card_see_more($context, array $blocks = [])
    {
        // line 54
        echo "                ";
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "modules", [])) > (isset($context["maxModulesDisplayed"]) ? $context["maxModulesDisplayed"] : null))) {
            // line 55
            echo "                  ";
            $this->loadTemplate("@PrestaShop/Admin/Module/Includes/see_more.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 55)->display(twig_array_merge($context, ["id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "refMenu", [])]));
            // line 56
            echo "                ";
        }
        // line 57
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/manage.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/manage.html.twig");
    }
}
