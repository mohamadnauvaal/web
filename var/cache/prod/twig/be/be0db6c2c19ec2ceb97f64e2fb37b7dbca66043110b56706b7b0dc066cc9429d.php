...
class __TwigTemplate_fcc5ff6b9c940c70df5cdd93d15408a463aa388a2d6f312ff368612364f9e4e9 extends \Twig\Template
{
...
";
    ...
    public function block_addon_card($context, array $blocks = [])
    {
        // line 28
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/card_list.html.twig", "@PrestaShop/Admin/Module/Includes/grid.html.twig", 28)->display(twig_array_merge($context, ["index" => (isset($context["index"]) ? $context["index"] : null), "module" => (isset($context["module"]) ? $context["module"] : null), "origin" => (((isset($context["origin"]) || array_key_exists("origin", $context))) ? (_twig_default_filter((isset($context["origin"]) ? $context["origin"] : null), "none")) : ("none")), "category" => (isset($context["id"]) ? $context["id"] : null)]));
        // line 29
        echo "    ";
    }
    ...
    public function block_addon_search_card($context, array $blocks = [])
    {
        // line 33
        echo "    ";
        if (((isset($context["requireAddonsSearch"]) || array_key_exists("requireAddonsSearch", $context)) && ((isset($context["requireAddonsSearch"]) ? $context["requireAddonsSearch"] : null) == true))) {
            // line 34
            echo "      ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid.html.twig");
    }
}
