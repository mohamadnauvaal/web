...
class __TwigTemplate_75cdd9255efcdd7ab5325971a9a046c9bd9c1f91e8c42176bb3550dd68c91517 extends \Twig\Template
{
...
<button id=\"";
        ...
        data-form-url=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath($this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "submit_route", []), $this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "route_params", [])), "html", null, true);
        echo "\"
        data-form-method=\"";
        // line 30
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Actions/Bulk/submit.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Actions/Bulk/submit.html.twig");
    }
}
