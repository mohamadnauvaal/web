...
class __TwigTemplate_453a0167ab772dc04292084e80707f5aad17ef4795c53ef7148ec8567edcfbb6 extends \Twig\Template
{
...
";
    ...
    public function block_test_email_sending($context, array $blocks = [])
    {
        // line 28
        echo "  ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["testEmailSendingForm"]) ? $context["testEmailSendingForm"] : null), 'form_start', ["action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_emails_send_test")]);
        echo "
      ...
      <div class=\"card\">
        ...
        echo "
              ...
              <div class=\"col-sm\">
                ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["testEmailSendingForm"]) ? $context["testEmailSendingForm"] : null), "send_email_to", []), 'widget');
        echo "
              </div>
            </div>
  ...
  ";
        // line 68
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["testEmailSendingForm"]) ? $context["testEmailSendingForm"] : null), 'form_end');
        echo "
";
    }
    ...
    {
        return new Source("", "@PrestaShop/Admin/Configure/AdvancedParameters/Email/Blocks/test_email_sending.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/Email/Blocks/test_email_sending.html.twig");
    }
}
