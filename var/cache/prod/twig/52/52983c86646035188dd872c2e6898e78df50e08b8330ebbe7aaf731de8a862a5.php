...
class __TwigTemplate_bc0d51d4fc8fd91fe24e47c98ef21615150e1a8fbd8e3d11ba0279c11a9e4d92 extends \Twig\Template
{
...
";
    ...
    public function block_product_catalog_filter_by_categories($context, array $blocks = [])
    {
        ...
        echo "
              ";
        // line 38
        if (((isset($context["selected_category"]) || array_key_exists("selected_category", $context)) &&  !(null === (isset($context["selected_category"]) ? $context["selected_category"] : null)))) {
            // line 39
            echo "                  (";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["selected_category"]) ? $context["selected_category"] : null), "getName", [], "method"), "html", null, true);
            echo ")
              ";
        }
        // line 41
    ...
    public function block_product_catalog_filter_bulk_actions($context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 97
        $context["buttons_action"] = twig_array_merge((isset($context["buttons_action"]) ? $context["buttons_action"] : null), [0 => ["divider" => true], 1 => ["onclick" => "bulkProductAction(this, 'duplicate_all');", "icon" => "content_copy", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Duplicate selection", [], "Admin.Actions")]]);
        // line 106
        echo "

          ";
        // line 108
        $context["buttons_action"] = twig_array_merge((isset($context["buttons_action"]) ? $context["buttons_action"] : null), [0 => ["divider" => true], 1 => ["onclick" => "bulkProductAction(this, 'delete_all');", "icon" => "delete", "label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Delete selection", [], "Admin.Actions")]]);
        // line 117
        echo "
          ";
        // line 118
...
(isset($context["buttons_action"]) ? $context["buttons_action"] : null)]));
  ...
  ";
    ...
    {
        return new Source("", "@Product/CatalogPage/Blocks/filters.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Product/CatalogPage/Blocks/filters.html.twig");
    }
}
