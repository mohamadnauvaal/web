...
class __TwigTemplate_65b0f2c098f6aac66036af843d9b0580361013291842c38cdc2828cc7e1c517c extends \Twig\Template
{
...
<a class=\"";
   ...
   data-category-id=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["record"]) ? $context["record"] : null), $this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "category_id_field", []), [], "array"), "html", null, true);
        echo "\"
   data-category-delete-url=\"";
        // line 35
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath($this->getAttribute($this->getAttribute((isset($context["action"]) ? $context["action"] : null), "options", []), "category_delete_route", []));
        echo "\"
   ";
        // line 36
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Actions/Row/delete_category.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Actions/Row/delete_category.html.twig");
    }
}
