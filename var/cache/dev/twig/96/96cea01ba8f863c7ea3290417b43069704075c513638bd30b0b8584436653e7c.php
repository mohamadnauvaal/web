...
class __TwigTemplate_42041002dd765a8ff87589d681dc2675fcaeee02d5cd0f9f85ce356c1175f27b extends \Twig\Template
{
    ...
    <div class=\"col-lg-10\">
      ";
        ...
        // line 35
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_addons_connect.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 35)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : $this->getContext($context, "errorMessage"))]));
        // line 36
        echo "      ";
        // line 37
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_import.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 37)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : $this->getContext($context, "errorMessage"))]));
        // line 38
        echo "      ";
        // line 39
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 39)->display(twig_array_merge($context, ["topMenuData" => (isset($context["topMenuData"]) ? $context["topMenuData"] : $this->getContext($context, "topMenuData")), "bulkActions" => (isset($context["bulkActions"]) ? $context["bulkActions"] : $this->getContext($context, "bulkActions"))]));
        // line 40
        echo "
      ";
        // line 41
...
";
    ...
    public function block_catalog_categories_listing($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["categories"]) ? $context["categories"] : $this->getContext($context, "categories")), "subMenu", []));
        $context['loop'] = [
    ...
    public function block_addon_card_see_more($context, array $blocks = [])
    {
        ...
        // line 54
        echo "                ";
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["category"]) ? $context["category"] : $this->getContext($context, "category")), "modules", [])) > (isset($context["maxModulesDisplayed"]) ? $context["maxModulesDisplayed"] : $this->getContext($context, "maxModulesDisplayed")))) {
            // line 55
            echo "                  ";
            $this->loadTemplate("@PrestaShop/Admin/Module/Includes/see_more.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 55)->display(twig_array_merge($context, ["id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : $this->getContext($context, "category")), "refMenu", [])]));
            // line 56
            echo "                ";
        }
        // line 57
...
{% endblock %}
", "@PrestaShop/Admin/Module/manage.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/manage.html.twig");
    }
}
