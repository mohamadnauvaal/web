...
class __TwigTemplate_aee3edc0cd7e35b05468f415354d2d6ab8edb060e379eed92a5177c8d64a8e32 extends \Twig\Template
{
...
(isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "attributes", []), "get", [0 => "_legacy_controller"], "method"), ((        // line 28
(isset($context["layoutTitle"]) || array_key_exists("layoutTitle", $context))) ? ((isset($context["layoutTitle"]) ? $context["layoutTitle"] : $this->getContext($context, "layoutTitle"))) : ("")), ((        // line 29
(isset($context["layoutHeaderToolbarBtn"]) || array_key_exists("layoutHeaderToolbarBtn", $context))) ? ((isset($context["layoutHeaderToolbarBtn"]) ? $context["layoutHeaderToolbarBtn"] : $this->getContext($context, "layoutHeaderToolbarBtn"))) : ([])), ((        // line 30
(isset($context["layoutDisplayType"]) || array_key_exists("layoutDisplayType", $context))) ? ((isset($context["layoutDisplayType"]) ? $context["layoutDisplayType"] : $this->getContext($context, "layoutDisplayType"))) : ("")), ((        // line 31
(isset($context["showContentHeader"]) || array_key_exists("showContentHeader", $context))) ? ((isset($context["showContentHeader"]) ? $context["showContentHeader"] : $this->getContext($context, "showContentHeader"))) : (true)), ((        // line 32
(isset($context["headerTabContent"]) || array_key_exists("headerTabContent", $context))) ? ((isset($context["headerTabContent"]) ? $context["headerTabContent"] : $this->getContext($context, "headerTabContent"))) : ("")), ((        // line 33
(isset($context["enableSidebar"]) || array_key_exists("enableSidebar", $context))) ? ((isset($context["enableSidebar"]) ? $context["enableSidebar"] : $this->getContext($context, "enableSidebar"))) : (false)), ((        // line 34
(isset($context["help_link"]) || array_key_exists("help_link", $context))) ? ((isset($context["help_link"]) ? $context["help_link"] : $this->getContext($context, "help_link"))) : ("")))), "@PrestaShop/Admin/layout.html.twig", 25);
    }
...
";
  ...
  ";
        // line 76
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "peek", [0 => "error"], "method")) > 0)) {
            // line 77
            echo "    ";
            echo $context["layout"]->getalert("danger", $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "get", [0 => "error"], "method"));
            echo "
  ";
        }
        // line 79
        echo "  ";
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "peek", [0 => "failure"], "method")) > 0)) {
            // line 80
            echo "    ";
            echo $context["layout"]->getalert("danger", $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "get", [0 => "failure"], "method"));
            echo "
  ";
        }
        // line 82
        echo "  ";
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "peek", [0 => "success"], "method")) > 0)) {
            // line 83
            echo "    ";
            echo $context["layout"]->getalert("success", $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "get", [0 => "success"], "method"));
            echo "
  ";
        }
        // line 85
        echo "  ";
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "peek", [0 => "warning"], "method")) > 0)) {
            // line 86
            echo "    ";
            echo $context["layout"]->getalert("warning", $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", []), "flashbag", []), "get", [0 => "warning"], "method"));
            echo "
  ";
        }
...
{% endblock %}
", "@PrestaShop/Admin/layout.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/layout.html.twig");
    }
}
