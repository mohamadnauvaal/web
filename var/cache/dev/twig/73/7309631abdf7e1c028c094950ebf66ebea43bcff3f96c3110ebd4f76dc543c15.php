...
class __TwigTemplate_542c8d2dbae0c2cb4f63509d296b3daf8e0b45e3fb652e510808e24400036262 extends \Twig\Template
{
...
";
        // line 26
        $context["displayAction"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans(twig_replace_filter(twig_capitalize_string_filter($this->env, (isset($context["action"]) ? $context["action"] : $this->getContext($context, "action"))), ["_" => " "]), [], "Admin.Actions");
        // line 27
        echo "
";
        // line 28
        if (((isset($context["action"]) ? $context["action"] : $this->getContext($context, "action")) == "configure")) {
            // line 29
            echo "
    <a class=\"";
            // line 30
      ...
      ";
            // line 31
            echo twig_escape_filter($this->env, (isset($context["displayAction"]) ? $context["displayAction"] : $this->getContext($context, "displayAction")), "html", null, true);
            echo "
    </a>
...
";
    ...
    <form class='";
            // line 36
            echo twig_escape_filter($this->env, (((isset($context["classes_form"]) || array_key_exists("classes_form", $context))) ? (_twig_default_filter((isset($context["classes_form"]) ? $context["classes_form"] : $this->getContext($context, "classes_form")))) : ("")), "html", null, true);
...
{% endif %}
", "@PrestaShop/Admin/Module/Includes/action_button.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/action_button.html.twig");
    }
}
