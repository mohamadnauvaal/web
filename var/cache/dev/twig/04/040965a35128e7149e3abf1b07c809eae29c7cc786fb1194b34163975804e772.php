...
class __TwigTemplate_983b0a473eb9d6541839593146df8fb7fb794bd0e16fd54af995cf0d0e374a52 extends \Twig\Template
{
  ...
  <div class=\"row\">
    ";
        ...
        ";
            // line 45
            $this->loadTemplate("@PrestaShop/Admin/Module/Includes/dropdown_categories.html.twig", "@PrestaShop/Admin/Module/Includes/menu_top.html.twig", 45)->display(twig_array_merge($context, ["topMenuData" => (isset($context["topMenuData"]) ? $context["topMenuData"] : $this->getContext($context, "topMenuData"))]));
            // line 46
            echo "      </div>
    ";
        }
    ...
    ";
        // line 49
        if (((isset($context["requireFilterStatus"]) || array_key_exists("requireFilterStatus", $context)) && ((isset($context["requireFilterStatus"]) ? $context["requireFilterStatus"] : $this->getContext($context, "requireFilterStatus")) == true))) {
            // line 50
            echo "      <div class=\"col-md-4 module-top-menu-item\">
        <h3>";
            // line 51
    ...
    ";
        // line 56
        if ((((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) > twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE")) && (isset($context["bulkActions"]) || array_key_exists("bulkActions", $context)))) {
            // line 57
...
", "@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "/home/hammerstoutdenim/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/menu_top.html.twig");
    }
}
