...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('DZDgmVzesD', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L5xqW0lZvD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'hammerstoutdenim', 'user' => 'hammerstoutdenim', 'password' => 'admin123', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_b4959aadbcd828b1ee2ced47977d617461cc2ed11431543bb548dae1a6211a4c');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('enLIf-vxRr', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eqOZV62VjD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+jtIJfQiTe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('XDPKQxqOJwGTMvKxkKXXVDR5RCHkxjGFtQbKwvupAZBWLbAnucb4Vrhp'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('XDPKQxqOJwGTMvKxkKXXVDR5RCHkxjGFtQbKwvupAZBWLbAnucb4Vrhp');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                57 => 'blockreassurance',
                58 => 'ps_facetedsearch',
                59 => 'revsliderprestashop',
                60 => 'iqitadditionaltabs',
                61 => 'iqithtmlandbanners',
                62 => 'iqitcompare',
                63 => 'iqitcontactpage',
                64 => 'iqitcookielaw',
                65 => 'iqitcrossselling',
                66 => 'iqitcountdown',
                67 => 'iqitelementor',
                68 => 'iqitemailsubscriptionconf',
                69 => 'iqitaddthisplugin',
                70 => 'iqitfreedeliverycount',
                71 => 'iqitlinksmanager',
                72 => 'iqitmegamenu',
                73 => 'iqitpopup',
                74 => 'iqitproductsnav',
                ...
                79 => 'iqitthemeeditor',
                80 => 'iqitwishlist',
                81 => 'iqitextendedproduct',
                82 => 'ph_simpleblog',
                83 => 'ph_blog_column_custom',
                84 => 'ph_relatedposts',
                85 => 'iqitdashboardnews',
                86 => 'iqitsociallogin',
                87 => 'adminmenu',
                88 => 'kurirq',
                89 => 'supercheckout',
            ...
            'database_port' => '',
            'database_name' => 'hammerstoutdenim',
            'database_user' => 'hammerstoutdenim',
            ...
            'secret' => 'XDPKQxqOJwGTMvKxkKXXVDR5RCHkxjGFtQbKwvupAZBWLbAnucb4Vrhp',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-07-29',
            'locale' => 'en-US',
            'cookie_key' => 'v5sR9Dph1Nv7W1XmpJcLO4yaxpwPqD2kF27J2PrHEGNDPKQ4jLZsQieS',
            'cookie_iv' => 'fP426Vvw',
            'new_cookie_key' => 'def00000021b458e5641808ba6857b18df84334db9a977b819c87bfef0f34b2ddc97b30a27431034711d5a2322834ec39e7fec52ddb9bcf291646f2b9abf6ccaa10ec55f',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'XDPKQxqOJwGTMvKxkKXXVDR5RCHkxjGFtQbKwvupAZBWLbAnucb4Vrhp',
